...
|------------------------+--------------------------------------------------------------------------------------+------------------+----------------------|
| snap-to-grid           | Defines a grid to which any annotation is snapped to.                                | <2015-12-02 Wed> | yes                  |
| mru                    | Update the Most-Recently-Used list with the currently opened page                    | <2015-12-02 Wed> | yes                  |
| layers                 | Option to see layers above the current one                                           | <2015-12-02 Wed> | yes                  |
| horizontal-scroll-lock | Option to Lock the scroll horizontally                                               | <2015-12-02 Wed> | yes                  |
| popupmenu              | Add a menu to right click on next/prev page to improve stylus navigation             | <2015-12-02 Wed> | yes                  |
| glade                  | Uses XML glade interface for configuration files                                     | <2015-12-02 Wed> | yes                  |
| fix-update-width       | Fixes annoyance: resets the width of selected strokes now keeps their variable width | <2015-12-02 Wed> | yes                  |
